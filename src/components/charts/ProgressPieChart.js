...
import {
  _genLabelsChart,
  _genWorkingProgressChart,
  _genLabelGroup1Chart,
  _genLabelGroup2Chart
} from "./genchart";
import DocumentTaggingStats from "./DocumentTaggingStats";
      ...
      <React.Fragment>
        <Row>
          {interfaceType === "Named Entities" && (
            <React.Fragment>
              <Button type="primary" onClick={this._refreshStats}>
                Refresh
              </Button>
              <Col span={24}>
          ...
          {interfaceType === "Document Tagging" && <DocumentTaggingStats />}
        </Row>
      </React.Fragment>
    );
  }
