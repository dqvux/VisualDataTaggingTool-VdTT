    ...
    render() {
        ...
        return (
            <Layout.Sider
                ...
                style={{ overflow: 'auto', height: '100vh', left: 0, top: 0, position: 'sticky' }}
            >
                <Menu mode="inline" theme='light' style={{ height: '100vh' }}>
                    ...
                    <Menu.Item className='sidebar-menu-item'>
                        <Icon type="read" className='sidebar-icon' /><span>Document</span>
                    </Menu.Item>
                    {this.props.children}
                    <Menu.Divider />
                    <Menu.Item onClick={this._leaveRepository}>
                        <Icon type="logout" className='sidebar-icon' /><span>Logout of <b>{repository.name}</b></span>
                    </Menu.Item>
