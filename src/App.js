...
class App extends React.Component {
  state = {
    currentRepository: 'currentRepository' in localStorage ? JSON.parse(localStorage.getItem('currentRepository')) : null
  }
  ...
  render() {
    ...
    if (!currentRepository)
      return (
        <Homepage _chooseRepository={this._chooseRepository} />
      )
    return (
      <HashRouter>
        <React.Fragment>
          <Switch>
            <Layout className='main-layout'>
              ...
              <InterfaceSwitcher interfaceType={currentRepository.type} repository={currentRepository} />
  ...
  _chooseRepository = (repository) => {
    ...
    this.setState({ currentRepository: repository }, localStorage.setItem('currentRepository', JSON.stringify(repository)))
  }
}
